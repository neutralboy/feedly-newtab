...
const LoginComponent = ({loading}: ILoginComponent) => {

    if(loading){
      return (
        <div className="bg-gray-800 rounded-md shadow-lg w-1/3 mx-auto p-6 px-8">
        
          <svg className="animate-spin h-10 w-10 text-white mx-auto block" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
